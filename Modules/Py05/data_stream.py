...
'''
implementar nova classe que chama as demais dentro e consoante a lista de argumentos e
a classe chamada o comportamento é válido ou não
ler melhor conversar com chat
'''